...
class Quadrotor3D:
    def __init__(self, drag=False, motor_noise=False):
        ...
        self.max_thrust = 20  # maximum thrust
        self.J = np.array([0.03, 0.03, 0.06])  # moment of inertia of quadrotor
        self.mass = 1.0  # Mass of Quadrotor
        self.length = 0.235  # half of the full arm length
        self.c = 0.013  # z-torque constant for motors
